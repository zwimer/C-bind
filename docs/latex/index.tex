...
This library should be compiled as a shared object without optimizations! On {\ttfamily gcc} version{\ttfamily 7.\+3}, this library is able to compile even with the {\ttfamily -\/\+O3} flag. If you experience issues however, try compiling at a lower optimization level. See the {\ttfamily C\+Make\+Lists.\+txt} file in the {\ttfamily examples} directory for an example.
