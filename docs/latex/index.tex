...
\hyperlink{bind_8h_a7c87cc0eb01b046c5adc0fb1d6fcd62c}{FullBound} bound\_func = \hyperlink{bind_8c_a31fdc3dfcbd70d3f32f4e3c8a2084c6a}{full\_bind}( sum, 2, \textcolor{comment}{/* Arguments begin */} 1, 2 );
...
\begin{DoxyCode}
\textcolor{keywordtype}{int} sum3(\textcolor{keywordtype}{int} a, \textcolor{keywordtype}{int} b, \textcolor{keywordtype}{int} c) \{ \textcolor{keywordflow}{return} a + b + c; \}
\hyperlink{bind_8h_a7d9e5f01a85ce68a0352f690b76f7910}{PartBound} bound\_func = \hyperlink{bind_8c_a187e674be73b611c4e8d97345192757a}{partial\_bind}( sum3, 3, 2, \textcolor{comment}{/* Arguments begin */} 100, 200 );
...
\#\#\# Full binding Example 
\begin{DoxyCode}
\hyperlink{bind_8h_a54aeeb54a7a6a62c72ec8dc7718fdd91}{ret\_t} sum( arg\_t * args ) \{ \textcolor{keywordflow}{return} args[0] + args[1]; \}
\hyperlink{bind_8h_a7c87cc0eb01b046c5adc0fb1d6fcd62c}{FullBound} bound\_func = full\_systemv\_bind( sum, 2, \textcolor{comment}{/* Arguments begin */} 1, 2 );
printf( \textcolor{stringliteral}{"sum(1,2) = %d"}, (\textcolor{keywordtype}{int}) bound\_func() );
\end{DoxyCode}
 The output of this code is\+: {\ttfamily sum(1,2) = 3}.
...
\#\#\# Partial binding Example 
\begin{DoxyCode}
\hyperlink{bind_8h_a54aeeb54a7a6a62c72ec8dc7718fdd91}{ret\_t} sum3( arg\_t * args ) \{ \textcolor{keywordflow}{return} args[0] + args[1] + args[2]; \}
\hyperlink{bind_8h_a7d9e5f01a85ce68a0352f690b76f7910}{PartBound} bound\_func = partial\_systemv\_bind( sum3, 3, 2, \textcolor{comment}{/* Arguments begin */} 100, 200 );
printf( \textcolor{stringliteral}{"Total sum = %d"}, (\textcolor{keywordtype}{int}) bound\_func(300) );
\end{DoxyCode}
 The output of this code is\+: {\ttfamily Total sum = 600} 
...
On {\ttfamily gcc} version{\ttfamily 7.\+3}, this library is able to compile even with the {\ttfamily -\/\+O3} flag. If you experience issues however, try compiling at a lower optimization level. See the {\ttfamily C\+Make\+Lists.\+txt} file in the {\ttfamily examples} directory for an example.
