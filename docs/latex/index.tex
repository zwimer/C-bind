...
Currently {\ttfamily C-\/bind} requires {\ttfamily pthread} to be installed, and requires {\ttfamily x86\+\_\+64}. {\ttfamily C-\/bind} has only been tested on {\ttfamily Ubuntu 18.\+04}
...
printf( \textcolor{stringliteral}{"sum(1,2) = %d\(\backslash\)n"}, (\textcolor{keywordtype}{int}) bound\_func() );
\end{DoxyCode}
